...
import task.SelectDestination_ExploreShoreExcursions_Task;
import task.SelectPort_ExploreShoreExcursions_Task;
...
public class ExploreShoreExcursions_StepDefinition {
    ...
    public void theGuestSelectsTheDestinationDropdown(String destination_from_feature) {
        ...
        theActorInTheSpotlight().attemptsTo(SelectDestination_ExploreShoreExcursions_Task.choosedestination(destination_from_feature));
    }
    ...
    public void theGuestFiltersForTheVancouverBritishColumbiaPort(String port_from_feature) {
        ...
        theActorInTheSpotlight().attemptsTo(SelectPort_ExploreShoreExcursions_Task.chooseport(port_from_feature));
    }
